...
<%--
	...
	0. 데이터 베이스 및 테이블 생성 
		...
		CREATE DATABASE SPRING_BOARD_EX1;
		USE SPRING_BOARD_EX1;
		CREATE TABLE BOARD(
	...
	9. 컨트롤러 생성
	10. servlet-context.xml파일에 controller,service,dao경로 작성 
	11. 화면 생성
--%>

<body>
	<div align="center" style="padding-top: 100px">
		<img src="resources/images/spring.PNG" alt="jsp심볼" width="600px" height="300px"><br><br><br><br>
